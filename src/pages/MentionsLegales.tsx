      ...
      <main className="pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-12">
            {/* Éditeur du site */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">1. Éditeur du site</h2>
            ...
            {/* Hébergement */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">2. Hébergement</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-3">
                <p className="text-white/90">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">3. Propriété intellectuelle</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">4. Protection des données personnelles</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
            ...
            {/* Cookies */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">5. Cookies</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
            ...
            {/* Responsabilité */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">6. Limitation de responsabilité</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
            ...
            {/* Droit applicable */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">7. Droit applicable</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-bold mb-4 text-white/90">8. Contact</h2>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
